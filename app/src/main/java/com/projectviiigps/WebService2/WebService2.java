...
public class WebService2 extends AsyncTask<String, Long, String> {
    ...
    private Asynchtask2 callback=null;

    public Asynchtask2 getCallback() {
        return callback;
    }
    public void setCallback(Asynchtask2 callback) {
     ...
     */
    public WebService2(String urlWebService, Map<String, String> data, Context activity, Asynchtask2 callback) {
    ...
    protected String doInBackground(String... params) {
        try {
            String r= HttpRequest2.post(this.url).form(this.datos).body();
            return r;

        } catch (HttpRequest2.HttpRequestException exception) {
    ...
    protected void onPostExecute(String response) {
        ...
        //Retorno los datos
        try {
            callback.processFinish2(this.xml);
