...
public class Preferences {
    ...
    public static final String PREFERENCE_USUARIO_LOGIN_USUARIO = "usuario.usuario";


    public static void savePreferenceStringUsuario(Context c, String b, String key){
        SharedPreferences preferences = c.getSharedPreferences(PREFERENCE_USUARIO_LOGIN_USUARIO,c.MODE_PRIVATE);
        preferences.edit().putString(key,b).apply();
    }
    public static String obtenerPreferenceStringUsuario(Context c,String key){
        SharedPreferences preferences = c.getSharedPreferences(PREFERENCE_USUARIO_LOGIN_USUARIO,c.MODE_PRIVATE);
